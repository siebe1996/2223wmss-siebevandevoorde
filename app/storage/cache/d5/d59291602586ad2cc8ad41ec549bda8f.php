...
/* edit.twig */
class __TwigTemplate_f8d6d00e85543aefc2b29d8127f952c6 extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("main.twig", "edit.twig", 1);
    ...
    public function block_pageContent($context, array $blocks = [])
    {
        ...
        if (($context["errors"] ?? null)) {
            ...
            echo "                    <!-- Display Validation Errors -->
                    ";
            // line 11
            $this->loadTemplate("errors.twig", "edit.twig", 11)->display($context);
            // line 12
            echo "                ";
        }
        // line 13
